import { faBed, faTaxi, faCar, faPlane, faCalendarDays, faPerson } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div className="header">
            <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
                ...
                {type !== "list" && (
                    <>
                        <h1 className="headerTitle">Book your Room and Get the best Experiences</h1>
                <p className="headerDesc">Get rewarded for your travels - unlock instant
                    saving of 15% or more!</p>
